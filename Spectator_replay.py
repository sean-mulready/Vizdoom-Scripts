...
episodes_filename = sub_id + " Episodes 1 to "+ str(episodes) +".csv"
with open(episodes_filename,'w', newline='') as starting_file:
...
endrows_filename = sub_id + " Summaries Episodes 1 to " + str(episodes) + ".csv"
with open(endrows_filename, 'w', newline='') as end_file:
...
with open(endrows_filename, 'a', newline='') as summary_file:
...
with open(episodes_filename, 'a', newline='') as file:
